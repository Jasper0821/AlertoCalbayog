...
export function SettingsIcon({ size = 22, color = "#0A1E3F" }: IconProps): React.JSX.Element {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function LogoutIcon({ size = 22, color = "#DC2626" }: IconProps): React.JSX.Element {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function UserIcon({ size = 22, color = "#0A1E3F" }: IconProps): React.JSX.Element {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function LockIcon({ size = 22, color = "#0A1E3F" }: IconProps): React.JSX.Element {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function CameraIcon({ size = 20, color = "#FFFFFF" }: IconProps): React.JSX.Element {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function GoogleIcon({ size = 20 }: { size?: number }): React.JSX.Element {
  return (
...
export function MailIcon({ size = 22, color = "#9CA3AF" }: IconProps): React.JSX.Element {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function FacebookIcon({ size = 20 }: { size?: number }): React.JSX.Element {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
        fill="#1877F2"
...
export function CheckIcon({ size = 14, color = "#FFFFFF" }: IconProps): React.JSX.Element {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
