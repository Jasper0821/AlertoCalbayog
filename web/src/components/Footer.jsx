export function Footer() {
  ...
  return (
    <footer className="mt-auto w-full shrink-0 border-t border-slate-800/60 bg-[#0f172a] px-4 py-1.5 text-slate-200 transition-colors duration-300 sm:px-8">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3">
        ...
        <div className="flex shrink-0 items-center gap-4">
          ...
          {/* Navigation Links */}
          <div className="hidden items-center gap-x-4 text-[10px] font-semibold text-slate-400 lg:flex">
            <a 
              href="#" 
