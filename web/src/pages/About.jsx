...
function About() {
 ...
 <h1 className="text-4xl sm:text-5xl font-bold text-[#0a1e3f] tracking-tight mb-6 leading-tight">
 Built to Protect <br />Calbayog City
 </h1>
 <p className="text-[17px] leading-relaxed text-[#5f6368] max-w-2xl mx-auto">
 ...
 {/* Mission */}
 <div className="bg-[#f8fafc] border-y border-slate-200 py-20 px-6 sm:px-10">
 <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
 <div>
 <h2 className="text-3xl font-bold text-[#0a1e3f] mb-5">Our Mission</h2>
 <p className="text-[16px] leading-relaxed text-[#5f6368] mb-4">
 ...
 <div className="text-3xl font-black text-[#0a1e3f] mb-2">{stat.value}</div>
 <div className="text-[11px] font-black uppercase tracking-widest text-[#5f6368]">{stat.label}</div>
 </div>
 ))}
 </div>
 </div>
 ...
 <h2 className="text-3xl font-bold text-[#0a1e3f] mb-12 text-center">Our Core Values</h2>
 <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
 {values.map((v) => (
 <div key={v.title} className="bg-white border border-slate-200 rounded-2xl p-7 hover:shadow-lg hover:shadow-slate-100 hover:-translate-y-1 transition-all duration-300">
 <div className="w-12 h-12 rounded-xl bg-[#0a1e3f] text-white flex items-center justify-center mb-5">
 {v.icon}
 </div>
 <h3 className="text-lg font-bold text-[#0a1e3f] mb-2">{v.title}</h3>
 <p className="text-[15px] text-[#5f6368] leading-relaxed">{v.desc}</p>
 </div>
 ))}
 </div>
 </div>
