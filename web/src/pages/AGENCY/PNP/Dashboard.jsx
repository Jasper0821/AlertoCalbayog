      ...
      >
        ...
        <div className="p-2 shrink-0" style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }}>
          ...
          >
            ...
            <span className={`transition-all duration-300 whitespace-nowrap ${isSidebarOpen || isSidebarHovered ? "opacity-100 w-auto" : "opacity-0 w-0 overflow-hidden"}`}>Logout Terminal</span>
          </button>
        </div>
