...
export const MOCK_QUEUE_REPORTS = {
  pending: [
    { _id: "q1", incidentId: "INC-2024-091", emergencyType: "fire",     userId: { fullName: "Pedro Reyes",  phoneNumber: "0918-777-8899" }, location: { name: "Brgy. Poblacion, Main Street",  barangay: "Poblacion", street: "Main St.",        purok: "Purok 2" }, status: "pending", createdAt: new Date(Date.now() - 300000).toISOString() },
    { _id: "q2", incidentId: "INC-2024-092", emergencyType: "medical",  userId: { fullName: "Ariel Cabral", phoneNumber: "0921-888-7766" }, location: { name: "Brgy. Hamorawon, San Jose St.", barangay: "Hamorawon", street: "San Jose St.",    purok: "Purok 4" }, status: "pending", createdAt: new Date(Date.now() - 600000).toISOString() },
    { _id: "q5", incidentId: "INC-2024-095", emergencyType: "disaster", userId: { fullName: "Lito Lapid",   phoneNumber: "0945-222-3344" }, location: { name: "Brgy. Dagum, Maharlika Hwy",    barangay: "Dagum",     street: "Maharlika Hwy", purok: "Purok 1" }, status: "pending", createdAt: new Date(Date.now() - 900000).toISOString() },
  ],
  active: [
    { _id: "q3", incidentId: "INC-2024-093", emergencyType: "fire",     userId: { fullName: "Mike Cruz",    phoneNumber: "0919-111-2222" }, location: { name: "Purok 3, Brgy. Nijaga, Calbayog City", barangay: "Nijaga", street: "Coastal Rd.",   purok: "Purok 3" }, status: "responding", createdAt: new Date(Date.now() - 800000).toISOString() },
    { _id: "q4", incidentId: "INC-2024-094", emergencyType: "medical",  userId: { fullName: "Sonia Santos", phoneNumber: "0932-444-5555" }, location: { name: "Purok 5, Brgy. Balud, Calbayog City", barangay: "Balud",  street: "Riverside St.", purok: "Purok 5" }, status: "responding", createdAt: new Date(Date.now() - 1500000).toISOString() },
  ],
};
