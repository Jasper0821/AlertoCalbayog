...
export const MOCK_QUEUE_REPORTS = {
  ...
  active: [
    { _id: "q3", incidentId: "INC-2024-093", emergencyType: "fire",     userId: { fullName: "Mike Cruz",    phoneNumber: "0919-111-2222" }, location: { name: "Brgy. Nijaga, Coastal Rd",  barangay: "Nijaga", street: "Coastal Rd.",   purok: "" },        status: "active", createdAt: new Date(Date.now() - 800000).toISOString() },
    { _id: "q4", incidentId: "INC-2024-094", emergencyType: "medical",  userId: { fullName: "Sonia Santos", phoneNumber: "0932-444-5555" }, location: { name: "Brgy. Balud, Riverside St", barangay: "Balud",  street: "Riverside St.", purok: "Purok 5" }, status: "active", createdAt: new Date(Date.now() - 1500000).toISOString() },
  ],
};
