...
export default function Settings({ user = {}, onUserUpdate }) {
  ...
  useEffect(() => {
    if (user) {
      ...
      setEmployeeId(user.employeeId || "CDRRMO-2024-001");
      ...
      setDepartment(user.department || user.agency || "CDRRMO");
      setBio(user.bio || "");
      setAvatar(user.avatar || "");
      setUsername(user.username || user.email || "officer@cdrrmo.gov.ph");
    ...
    try {
      ...
      setAgencyCode(cfg.agencyCode || user.agency || "CDRRMO");
      ...
      setAgencyCode(user.agency || "CDRRMO");
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="pt-6 border-t border-slate-100 space-y-4">
                    ...
                    <div className="bg-slate-50 rounded-xl border border-slate-100 p-4 pt-3.5">
                      ...
                      >
                        Simulate Incoming Emergency Alert Popup & Sound
                      </button>
                    </div>
                  </div>
                </div>
