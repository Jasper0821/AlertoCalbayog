...
function MapSection({ reports: pins = [], isOffline }) {
 ...
 action={isOffline ? <span className="text-[10px] font-black text-red-600 bg-red-50 px-4 py-1.5 rounded-full border border-red-100 uppercase tracking-widest">Offline Mode</span> : <span className="text-[10px] font-black text-emerald-600 bg-emerald-50 px-4 py-1.5 rounded-full border border-emerald-100 uppercase tracking-widest">Database Sync Active</span>}
 />
 </div>
 ...
 className="absolute bottom-6 right-6 z-[400] flex h-12 items-center justify-center gap-2 rounded-xl bg-slate-900 px-6 text-[10px] font-black uppercase tracking-[0.2em] text-white shadow-2xl transition-all hover:bg-black hover:scale-[1.05] active:scale-95"
 >
 ...
 <p className="text-sm font-black tracking-tight text-slate-900 uppercase transition-colors">Exit Terminal</p>
 </div>
 </button>
 </div>
 ...
 <p className="mt-2 text-[9px] font-bold text-slate-500 uppercase tracking-widest">{pin.location?.name ||"Sector Alpha"}</p>
 </div>
