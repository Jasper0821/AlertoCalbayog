...
export function ProfileSection() {
 ...
 {isEditing ? (
 <form onSubmit={handleSave} className="w-full max-w-3xl rounded-[40px] border border-slate-100 bg-white p-8 sm:p-12 shadow-2xl shadow-slate-200/50 transition-all">
 ...
 className="h-14 px-10 rounded-2xl bg-slate-50 border border-slate-100 text-[10px] font-black uppercase tracking-widest text-slate-500 transition-all"
 >
 Dismiss
 </button>
 </div>
 ...
 <article className="rounded-[40px] border border-slate-100 bg-white p-8 sm:p-12 w-full max-w-3xl shadow-2xl shadow-slate-200/50 transition-all text-center sm:text-left">
 ...
 <h3 className="font-display text-3xl sm:text-4xl font-black tracking-tighter text-slate-900 transition-colors">
 {profileData.name}
 </h3>
 <p className="mt-4 text-base sm:text-lg font-bold text-slate-600 leading-relaxed transition-colors">
 ...
 <strong className="mt-2 block text-sm font-black text-slate-900 transition-colors">{item.value}</strong>
 </div>
 ))}
 </div>
 </article>
