...
export function ReportsSection({ reports = [] }) {
 ...
 <SectionHeader
 title="Incident log"
 action={<span className={`${pillBase} border-slate-100 bg-slate-50 text-slate-500 capitalize font-black tracking-widest transition-colors`}>Historical Archive</span>}
 />
 ...
 <div className="mt-10 p-8 border-t border-slate-100 flex items-center justify-between transition-colors">
 <p className="text-[10px] font-black uppercase tracking-widest text-slate-500">Showing {reports.length} Reports</p>
 ...
 <button className="h-10 px-4 rounded-xl border border-slate-100 text-[10px] font-black text-slate-900 uppercase tracking-widest bg-slate-50 border-slate-200 transition-all">Next</button>
 </div>
 </div>
 </div>
 </section>
