...
export default function DashboardOverview({ reports = [], setActiveNav, onStatusChange }) {
  ...
  return (
    <div style={{
      ...
      {/* Charts row */}
      <div style={{ display:"grid", gridTemplateColumns:"1.55fr 1fr", gap:6, flex:1, minHeight:0 }}>

        {/* Case Overview chart — this month daily */}
        <div style={{ background:"#fff", borderRadius:12, padding:"6px 10px", boxShadow:"0 1px 4px rgba(0,0,0,0.05)", display:"flex", flexDirection:"column" }}>
        ...
        {/* Calendar */}
        <div style={{ background:"#fff", borderRadius:12, padding:"6px 10px", boxShadow:"0 1px 4px rgba(0,0,0,0.05)" }}>
      ...
      <div style={{ background:"#fff", borderRadius:12, boxShadow:"0 1px 4px rgba(0,0,0,0.05)", overflow:"hidden", flexShrink:0 }}>
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"6px 10px", borderBottom:"1px solid #f1f5f9" }}>
          <div>
        ...
        <table style={{ width:"100%", borderCollapse:"collapse" }}>
          <thead>
            <tr style={{ background:"#f8fafc" }}>
              ...
              {["No.","Reporter","Incident Type","Date Reported","Status","Location","Contact No.","Action"].map(h=>(
          ...
          <tbody>
            {tableRows.length===0 ? (
              <tr><td colSpan={9} style={{ padding:"20px 0", textAlign:"center", fontSize:11, color:"#94a3b8" }}>No incidents for this period</td></tr>
            ) : tableRows.map((r,i)=>{
                ...
                <tr key={r._id||i} style={{ borderTop:"1px solid #f8fafc", transition:"background .12s" }}
                  ...
                  <td style={TD}>
                    <div style={{ display:"flex", gap:8 }}>
                      <button title="Edit" onClick={()=>setActiveNav?.("incident-reports")}
