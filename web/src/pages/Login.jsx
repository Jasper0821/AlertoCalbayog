  ...
  return (
    <main className="relative flex h-dvh flex-col overflow-hidden bg-[#f4f7fc] font-sans antialiased transition-colors duration-300">
      ...
      <div className="relative flex min-h-0 flex-1 flex-col items-center justify-center px-4 pt-20 pb-3">
        ...
        <section className="relative z-10 w-full max-w-[380px] overflow-hidden rounded-2xl border border-slate-200/60 bg-white p-5 shadow-[0_20px_50px_-20px_rgba(0,0,0,0.08)] sm:p-6">
          ...
          <form className="space-y-3.5" onSubmit={handleSubmit}>
            <div className="grid gap-1.5 text-left">
              ...
              <div className="relative flex items-center">
                ...
                <input
                  className="h-10 w-full rounded-lg border border-slate-200 bg-white pl-10 pr-4 text-[13px] text-slate-900 outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder:text-slate-300 shadow-sm"
                  id="email"
                  name="email"
                  type="email"
            ...
            <div className="grid gap-1.5 text-left">
              ...
              <div className="relative flex items-center">
                ...
                <input
                  className="h-10 w-full rounded-lg border border-slate-200 bg-white pl-10 pr-10 text-[13px] text-slate-900 outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder:text-slate-300 shadow-sm"
                  id="password"
                  name="password"
