  ...
  return (
    <main className="relative flex flex-col min-h-screen bg-slate-50 font-sans antialiased">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-20 sm:py-24 sm:px-6 lg:px-8 relative">
        ...
        <section className="relative w-full max-w-xl overflow-hidden rounded-3xl border border-slate-100 bg-white p-6 sm:p-8 shadow-[0_50px_120px_-30px_rgba(0,0,0,0.12),0_0_1px_rgba(0,0,0,0.1)]">
          <div className="mb-10 flex flex-wrap items-center justify-between gap-4">
            ...
            <span className="inline-flex items-center gap-2 rounded-full border border-emerald-100 bg-emerald-50 px-5 py-2.5 text-xs font-black uppercase tracking-[0.1em] text-emerald-600">
              Resident Enrollment
            </span>
          </div>
          ...
          <form className="mt-12 space-y-6" onSubmit={handleSubmit}>
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="grid gap-2 sm:col-span-2">
                <label className="text-xs font-black uppercase tracking-widest text-slate-400 ml-1" htmlFor="fullName">
                  Full Name
                </label>
                <input
              ...
              <div className="grid gap-2">
                <label className="text-xs font-black uppercase tracking-widest text-slate-400 ml-1" htmlFor="phoneNumber">
                  Phone Number
                </label>
                <input
                  className="h-12 w-full rounded-xl border border-slate-100 bg-white px-5 text-slate-900 outline-none transition shadow-sm focus:border-red-600 focus:ring-4 focus:ring-red-600/5 placeholder:text-slate-300"
            ...
            <div className="flex justify-center mt-2">
              <button
                className="group relative flex h-12 items-center justify-center overflow-hidden rounded-xl bg-slate-900 px-12 text-xs font-black uppercase tracking-[0.2em] text-white shadow-2xl shadow-slate-900/20 transition-all hover:bg-black hover:scale-[1.02] active:scale-95 disabled:opacity-50 disabled:scale-100 disabled:bg-slate-400 disabled:cursor-not-allowed"
                type="submit"
