      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 pt-32 pb-20 relative">
        ...
        <section className="relative w-full max-w-[420px] overflow-hidden rounded-2xl border border-slate-200/60 dark:border-slate-800 bg-white dark:bg-slate-900 p-7 sm:p-8 shadow-[0_20px_50px_-20px_rgba(0,0,0,0.08)] z-10">
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <h1 className="text-xl font-black tracking-tight text-[#0a1e3f] dark:text-white uppercase">
              {otpVerified ? "Create New Password" : "Verify Your Identity"}
            </h1>
            <p className="text-[12px] text-slate-500 dark:text-slate-400 mt-1.5 text-center leading-relaxed max-w-[280px]">
              {otpVerified
          ...
          {!otpVerified && (
            <form onSubmit={handleVerify} className="space-y-5">
              ...
              <div className="flex justify-between gap-2" onPaste={handlePaste}>
                {otp.map((data, index) => (
                  <input
                    ...
                    className={`h-14 w-full rounded-xl border text-center text-xl font-black text-slate-900 dark:text-white outline-none transition shadow-sm
                      ${otpError
                        ? "border-red-500 bg-red-50 dark:bg-red-950/20 focus:ring-2 focus:ring-red-500/20"
                        : "border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10"
                      }`}
                    required
                  />
                ))}
              ...
              {/* OTP Error */}
              {otpError && (
                <div className="flex items-start gap-2 bg-red-50 dark:bg-red-950/20 border border-red-100 dark:border-red-900/30 rounded-xl px-3.5 py-3">
              ...
              {/* Footer info */}
              <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-600">
          ...
          {otpVerified && !resetSuccess && (
            <form onSubmit={handleResetPassword} className="space-y-5">
              ...
              <div className="grid gap-1.5 text-left">
                <label className="text-[11px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 ml-0.5" htmlFor="newPassword">
                  New Password
                </label>
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="h-11 w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 pl-11 pr-11 text-[14px] text-slate-900 dark:text-white outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder:text-slate-300 dark:placeholder:text-slate-700 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                    required
                  />
                  <button
                    type="button"
              ...
              {/* Confirm Password */}
              <div className="grid gap-1.5 text-left">
                <label className="text-[11px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 ml-0.5" htmlFor="confirmPassword">
                  Confirm Password
                </label>
                <div className="relative flex items-center">
                  <span className="absolute left-3.5 text-slate-400">
          ...
          {resetSuccess && (
            <div className="flex flex-col items-center py-4 space-y-4 text-center">
              ...
              <h3 className="text-base font-black text-slate-900 dark:text-white uppercase">Password Updated!</h3>
        ...
        <div className="mt-5 z-10">
          <Link
            to="/login"
            className="inline-flex items-center justify-center gap-2 px-4 py-1.5 rounded-lg border border-dashed border-blue-500 text-xs font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all duration-150 active:scale-95 transform"
          >
